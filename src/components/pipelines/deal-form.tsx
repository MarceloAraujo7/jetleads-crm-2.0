...
interface DealFormProps {
  ...
  /** Pre-selects a contact when creating a new deal (e.g. "Criar
   *  negócio" from the Inbox contact sidebar). Ignored when editing
   *  an existing deal — `deal.contact_id` wins there. */
